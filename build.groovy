...
def initialize(ocpVersion, rhcosBuild, arch, name, mirrorPrefix) {
    ...
    // doozer --group=openshift-4.12 config:read-group --default '' urls.rhcos_release_base.multi
    // https://releases-rhcos-art.apps.ocp-virt.prod.psi.redhat.com/storage/prod/streams/4.12/builds/412.86.202212081411-0/x86_64/meta.json
    // https://releases-rhcos-art.apps.ocp-virt.prod.psi.redhat.com/storage/releases/rhcos-4.8/48.84.202301100936-0/x86_64/meta.json
    // https://releases-rhcos-art.apps.ocp-virt.prod.psi.redhat.com/storage/releases/rhcos-4.12-s390x/412.86.202211290908-0/s390x/meta.json
